...
export const CATALOG = [
  ...
  },
  {
    ...
    name: "재료별 조리 가이드 카드 (IDDSI 기준)",
    sub: "형태별 조리법 — 곱게 감 · 잘게 다져 촉촉 · 부드러운 한입 · 일반식",
    why: "지금 주고 있는 형태를 재료별로 어떻게 만드는지 정리했어요. 식품 배송 없이 오늘 바로 씁니다.",
    homeFirst: "삶는 시간을 달리하면(푹·중간·살짝) 같은 재료로 형태를 바꿔볼 수 있어요.",
...
export const PROGRAM = {
  ...
  name: "4주 식감 연습 프로그램",
  sub: "1주 지금 형태 확인 → 2주 조리법 바꿔보기 → 3주 익숙한 음식과 함께 → 4주 변화 비교 · 매주 영상 재분석",
  why: "매주 한 가지만 바꾸고, 그 주에 쓰는 준비물을 함께 보내드려요. 형태를 올리는 계획이 아니라, 지금 형태에서 무엇을 바꿔볼지 한 주에 하나씩 정하는 구성이에요.",
  price: 59000,
};
...
export const ACTIONS = {
  texture: {
    label: "질감·크기",
    action: "지금 편하게 먹는 음식 형태는 유지하고, 연습할 음식은 한 조각만 따로 내보세요.",
    watch: "한 조각을 보고·만지고·입에 대는 반응이 식사마다 조금 편해지는지",
    home: "현재 음식 단계를 낮추거나 숨겨 섞지 말고, 같은 접시 한쪽에 소량만 두어 아이가 직접 탐색하고 선택하게 해주세요.",
  },
  repetition: {
    label: "익숙함·반복 노출",
